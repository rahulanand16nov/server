...
/*
  A combination of all SUPER privileges added since user table format.
...
*/
constexpr privilege_t  GLOBAL_SUPER_ADDED_SINCE_USER_TABLE_ACL=
  SET_USER_ACL |
  FEDERATED_ADMIN_ACL |
...
constexpr privilege_t GLOBAL_ACLS=
  ...
  GLOBAL_SUPER_ADDED_SINCE_USER_TABLE_ACL |
